		...
		<div class="index">
			...
			<form action="AddTest.jsp" method="post">
				<ol>
					...
					<label><input type="radio" name="testType" value="Antigen Rapid Test Kit (RTK)" />Antigen Rapid Test Kit (RTK)Antigen Rapid Test Kit (RTK) </label>
				...
				Name: <input type="text" name="pname" value="<%=p.getPname()%>" />
				IC NO.:<input type="text" name="IC" value="<%=p.getIC()%>" />
				Phone: <input type="tel" name="phone" value="<%=p.getNumber()%>" />
				<br />
